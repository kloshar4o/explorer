<template>
    <div id="desktop-toolbar">
        <div class="toolbar-wrapper" v-if="!showEditor">
            ...
            <div class="toolbar-go-back" v-if="homeDirectory">
                <div @click="goBack" class="go-back-button">
                    ...
                    <span @click.stop="folderActions"
                          v-if="browseHistory.length > 1 && $isThisLocation(['base', 'public'])"
            ...
            <div class="toolbar-tools">
                ...
                <div class="toolbar-button-wrapper" v-if="$checkPermission(['master', 'editor'])">
                    ...
                    <ToolbarButton
                            source="file-plus"
                            :class="{ 'is-inactive': canUploadInView || !hasCapacity }"
                            @click.native="createMdFile"
                            :action="$t('actions.add_md')">
                    </ToolbarButton>

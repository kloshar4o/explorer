<template>
    <div>
        ...
        <div @click="closeAndResetContextMenu" v-show="isVisible && !showFromPreview"
             :style="{ top: positionY + 'px', left: positionX + 'px' }"
             class="contextmenu"
             ref="contextmenu">

            <!--ContextMenu for trash location-->
            <div v-if="$isThisLocation(['trash', 'trash-root']) && $checkPermission('master')"
                 id="menu-list"
                 class="menu-options">

                <ul class="menu-option-group">
                    <li @click="$store.dispatch('restoreItem', item)"
                        class="menu-option"
                        v-if="item">
                    ...
                    <li @click="deleteItem" class="menu-option" v-if="item">
                        <div class="icon">
                            <trash-2-icon size="17"></trash-2-icon>
                        </div>
                        <div class="text-label">
                    ...
                    <li @click="$store.dispatch('emptyTrash')" class="menu-option">
                        <div class="icon">
                ...
                <ul class="menu-option-group" v-if="item">
                    <li @click="ItemDetail" class="menu-option">
                        <div class="icon">
                    ...
                    <li @click="downloadItem" class="menu-option" v-if="!isFolder">
                        <div class="icon">
                            <download-cloud-icon size="17"></download-cloud-icon>
                        </div>
                        <div class="text-label">
            ...
            <div v-if="$isThisLocation(['shared']) && $checkPermission('master')"
                 id="menu-list"
                 class="menu-options">

                <ul class="menu-option-group" v-if="item && isFolder">
                    <li @click="addToFavourites" class="menu-option">
                        <div class="icon">
                ...
                <ul class="menu-option-group" v-if="item">
                    <li @click="shareItem" class="menu-option">
                        <div class="icon">
                            <link-icon size="17"></link-icon>
                        </div>
                        <div class="text-label">
                    ...
                    <li @click="deleteItem" class="menu-option">
                        <div class="icon">
                            <trash-2-icon size="17"></trash-2-icon>
                        </div>
                        <div class="text-label">
                ...
                <ul class="menu-option-group" v-if="item">
                    <li @click="ItemDetail" class="menu-option" v-if="item">
                        <div class="icon">
                            <eye-icon size="17"></eye-icon>
                        </div>
                        <div class="text-label">
            ...
            <!-- User Base & Latest-->
            <!--ContextMenu for Base location with MASTER permission-->
            <div v-if=" $isThisLocation(['base', 'participant_uploads', 'latest']) && $checkPermission('master')"
                 id="menu-list"
                 class="menu-options">
                <ul v-if="!$isThisLocation(['participant_uploads', 'latest'])" class="menu-option-group">
                    <li @click="addToFavourites" v-if="item && isFolder" class="menu-option">
                        <div class="icon">
                            <star-icon size="17"></star-icon>
                        </div>
                        <div class="text-label">
                    ...
                    <li @click="createFolder" class="menu-option">
                        <div class="icon">
                ...
                <!--Edit md file-->
                <ul class="menu-option-group" v-if="isMdFile">
                    <li @click="previewMdFile" class="menu-option">
                        <div class="icon">
                            <eye-icon size="17"></eye-icon>
                        </div>
                        <div class="text-label">
                            {{ $t("context_menu.preview_md") }}
                        </div>
                    </li>
                    <li @click="$store.dispatch('openEditor')" v-if="!isFolder" class="menu-option">
                        <div class="icon">
                            <edit-2-icon size="17"></edit-2-icon>
                        </div>
                        <div class="text-label">
                            {{ $t("context_menu.edit_md") }}
                        </div>
                    </li>
                </ul>

                <ul class="menu-option-group" v-if="item">
                    <li @click="moveItem" class="menu-option">
                        <div class="icon">
                            <corner-down-right-icon size="17"></corner-down-right-icon>
                        </div>
                        <div class="text-label">
                ...
                <ul class="menu-option-group" v-if="item">
                    ...
                    <li @click="downloadItem" v-if="!isFolder" class="menu-option">
                        <div class="icon">
                            <download-cloud-icon size="17"></download-cloud-icon>
                        </div>
                        <div class="text-label">
            ...
            <div v-if="$isThisLocation(['base', 'public']) && $checkPermission('editor')"
                 id="menu-list"
                 class="menu-options">
                <ul class="menu-option-group">
                    <li @click="createFolder" class="menu-option">
            ...
            <div v-if="$isThisLocation(['base', 'public']) && $checkPermission('visitor')"
                 id="menu-list"
                 class="menu-options">

                <ul v-if="item" class="menu-option-group">
                    <li @click="ItemDetail" class="menu-option">
                        <div class="icon">
                            <eye-icon size="17"></eye-icon>
                        </div>
